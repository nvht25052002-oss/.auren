...
export default function Slide08Bolt() {
  return (
    <div style={root}>
      <DocsSidebar active="Bolt.new" />
      <div style={main}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "2vw", marginBottom: "1.5vh" }}>
          <h1 style={{ fontSize: "3.8vw", fontWeight: 700, color: "#FFFFFF", margin: 0, letterSpacing: "-0.02em" }}>Bolt.new</h1>
        ...
        <div style={{ fontSize: "1.05vw", color: "#565F89", marginBottom: "3vh" }}>StackBlitz · Cloud SaaS · Closed Source</div>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "2.5vh" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "1vw" }}>
                    <div style={{ width: "10vw", height: "0.5vh", backgroundColor: "rgba(255,255,255,0.08)", borderRadius: "4px", overflow: "hidden" }}>
                      <div style={{ width: "80%", height: "100%", backgroundColor: "#E0AF68", borderRadius: "4px" }} />
                    </div>
                    <span style={{ fontSize: "0.9vw", color: "#E0AF68", fontFamily: "'DM Mono', monospace" }}>80/100</span>
                  </div>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span style={{ fontSize: "1vw", color: "#9AA5CE" }}>WebContainers</span>
                  <span style={{ fontSize: "0.9vw", color: "#9ECE6A", fontFamily: "'DM Mono', monospace" }}>in-browser npm</span>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "1.05vw", color: "#9AA5CE", lineHeight: 1.6, margin: 0 }}>
                Runs a full Node.js/npm environment directly in the browser via WebContainers. Zero setup — paste a URL, get a running full-stack app in seconds.
              </p>
            </div>
          </div>

          <div style={{ flex: 1 }}>
            <div style={{ fontSize: "1.05vw", fontWeight: 600, color: "#FFFFFF", marginBottom: "1.5vh", borderBottom: "1px solid rgba(255,255,255,0.07)", paddingBottom: "1vh" }}>WebContainer Architecture</div>
            <div style={code}>
              <div style={{ color: "#565F89", marginBottom: "0.5vh" }}>{"// Browser → WebContainer"}</div>
              <div style={{ color: "#C0CAF5" }}>{`{`}</div>
              <div style={{ paddingLeft: "2vw" }}><span style={{ color: "#7AA2F7" }}>"runtime"</span>: <span style={{ color: "#9ECE6A" }}>"WebContainer v2"</span>,</div>
              <div style={{ paddingLeft: "2vw" }}><span style={{ color: "#7AA2F7" }}>"environment"</span>: <span style={{ color: "#9ECE6A" }}>"browser-native"</span>,</div>
              <div style={{ paddingLeft: "2vw" }}><span style={{ color: "#7AA2F7" }}>"npm"</span>: <span style={{ color: "#9ECE6A" }}>"full support"</span>,</div>
              <div style={{ paddingLeft: "2vw" }}><span style={{ color: "#7AA2F7" }}>"serverless"</span>: <span style={{ color: "#9ECE6A" }}>true</span>,</div>
              <div style={{ paddingLeft: "2vw" }}><span style={{ color: "#7AA2F7" }}>"latency"</span>: <span style={{ color: "#9ECE6A" }}>"~0ms (local)"</span></div>
              <div style={{ color: "#C0CAF5" }}>{`}`}</div>
            </div>
            <div style={{ marginTop: "2.5vh", backgroundColor: "rgba(224,175,104,0.06)", borderRadius: "0.5vw", padding: "2vh 2vw", border: "1px solid rgba(224,175,104,0.15)" }}>
              <div style={{ fontSize: "0.95vw", color: "#E0AF68", fontWeight: 600, marginBottom: "1vh" }}>Best for</div>
              <div style={{ fontSize: "1vw", color: "#9AA5CE", lineHeight: 1.5 }}>Rapid prototyping and demos without any local environment setup — ideal for sharing live previews instantly.</div>
            </div>
          </div>
        </div>

        <div style={{ display: "flex", justifyContent: "space-between", marginTop: "2vh" }}>
          <div style={{ fontSize: "0.9vw", color: "#565F89" }}>08</div>
